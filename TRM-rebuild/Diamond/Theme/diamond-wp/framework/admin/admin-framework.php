									...
									<div class="ewf-ui-background-image">
										...
										<div class="ewf-ui-background-setting ewf-ui-hlp-property">
											<div class="fixed">
												...
												$background_repeat = array('repeat'=>null, 'repeat-x'=>null, 'repeat-y'=>null, 'no-repeat'=> null);
												$background_repeat[$background_properties['background-repeat']] = ' active';
												
										   echo '<ul class="fixed">
													<li title="" class="ewf-tooltip ewf-ui-icon-bg-repeatall'.$background_repeat['repeat'].'" data-value="repeat"></li>
