...
class CSFramework_Enqueue_API extends CSFramework_Abstract {
  ...
  public function admin_enqueue_scripts() {
    ...
    wp_enqueue_script( 'jquery.cookie', FRAMEWORK_ASSETS.'/js/jquery.cookie.js', array('jquery'), '1.4.0', true );
    ...
    wp_enqueue_script( 'cs-framework', FRAMEWORK_ASSETS.'/js/cs-framework.js', array('jquery', 'jquery.cookie', 'chosen', 'jquery-interdependencies'), '1.0.0', true );
