...
;(function ( $, window, document, undefined ) {
  ...
  $.fn.ROUTEWP_typography = function() {
    return this.each(function() {
      ...
      var typography          = $(this),
          ...
          typography_preview  = typography.find('.typography-preview'),
      ...
      typography_select.unbind('change').bind('change',function(){
        ...
        switch( _type ){
          ...
          case 'safefonts':
            ...
            // clear google font link
            if( typography_preview.length ){
              googlefonts_link.attr( 'href', '' );
              typography_preview.css({'font-family': _current, 'font-weight': 'normal', 'font-style': 'normal'});
            }
          ...
          case 'googlefonts':
            ...
            // get variants from footer-json
            variants = cs_google_fonts[_current];
            ...
            // set font for live-preview
            if( typography_preview.length ){
              googlefonts_link.attr( 'href', 'https://fonts.googleapis.com/css?family=' + _current.replace(/\s/g, '+') );
              typography_preview.css({'font-family': _current, 'font-weight': 'normal', 'font-style': 'normal'});
            }
  ...
  $.reloadJSPlugins = function() {
    ...
    $('.cs-color-picker').wpColorPicker({ palettes:["#000000", "#ffffff",  "#6e6e6e", "#428bca", "#5cb85c", "#d9534f", "#f0ad4e"]});
