...
class CSFramework_Option_typography extends CSFramework_Options_API {
  ...
  public function output() {
    ...
    echo '<select name="'. $this->element_name('[family]') .'" class="chosen typography-select" data-atts="family">';
    ...
    $variants = ( cs_is_googe_font( $this->value['family'] ) ) ? $webfonts[$this->value['family']] : $default_variants;
    echo '<li class="cs-variant">';
    echo '<select name="'. $this->element_name('[variant]') .'" class="chosen typography-variant-select" data-atts="variant">';
