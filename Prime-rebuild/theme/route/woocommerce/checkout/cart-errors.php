...
<p><a class="button wc-backward <?php echo cs_get_button_class( array( 'size' => 'xxs' ) ); ?>" href="<?php echo get_permalink(wc_get_page_id( 'cart' ) ); ?>"><?php _e( 'Return To Cart', 'woocommerce' ) ?></a></p>