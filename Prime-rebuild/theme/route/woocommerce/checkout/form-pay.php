...
<form id="order_review" method="post">
	...
	<div id="payment">
		...
		<h4><?php _e( 'Payment', 'woocommerce' ); ?></h4>
						...
						<li class="payment_method_<?php echo $gateway->id; ?>">
							...
							<?php
								if ( $gateway->has_fields() || $gateway->get_description() ) {
									echo '<div class="cs-alert cs-alert-info payment_box payment_method_' . $gateway->id . '" style="display:none;">';
		...
		<div class="form-row place-order">
			...
			<?php
				...
				echo apply_filters( 'woocommerce_pay_order_button_html', '<input type="submit" class="button alt '. cs_get_button_class( array('size' => 'md' ) ) .'" id="place_order" value="' . esc_attr( $pay_order_button_text ) . '" data-value="' . esc_attr( $pay_order_button_text ) . '" />' );
			?>			
