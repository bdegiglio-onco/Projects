...
<form class="shipping_calculator" action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">
	...
	<h4><a href="#" class="shipping-calculator-button <?php echo cs_get_button_class( array( 'size' => 'xxs', 'type' => 'outlined', 'color' => 'outlined-accent' ) ); ?>"><?php _e( 'Calculate Shipping', 'woocommerce' ); ?> <i class="fa fa-arrow-down"></i></a></h4>
	...
	<section class="shipping-calculator-form">
		...
		<p><button type="submit" name="calc_shipping" value="1" class="button <?php echo cs_get_button_class(); ?>"><?php _e( 'Update Totals', 'woocommerce' ); ?></button></p>
