...
<form id="add_payment_method" method="post">
	<div id="payment">
		...
		<div class="form-row place-holder">
			<?php wp_nonce_field( 'woocommerce-add-payment-method' ); ?>
			<input type="submit" class="button alt <?php echo cs_get_button_class( array('size' => 'md' ) ); ?>" id="place_order" value="<?php _e( 'Add Payment Method', 'woocommerce' ); ?>" />
