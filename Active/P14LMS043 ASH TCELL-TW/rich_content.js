...
<script type="text/javascript">
  ...
  prime.init({
  //minimum setup
 uri: 'http://primepresentations.s3.amazonaws.com/2014/ash-tcell/advani/',
  slidePrefix: 'Slide',
  jpgCase: '.JPG',
...
<!--End Player -->
<!-- PRESENTATION -->
<script src="http://primepresentations.s3.amazonaws.com/2014/ash-tcell/advani/presentation.js">
</script>
<div id="presentation" style="margin-left:7px;">
  <div id="video">
    <video id="videoplayer" width="470" height="344" poster="http://primepresentations.s3.amazonaws.com/2014/ash-tcell/advani/video.jpg" controls preload="true">
      ...
      <source type="video/mp4" src="http://primepresentations.s3.amazonaws.com/2014/ash-tcell/advani/videos/video.mp4" />
      <!-- WebM/VP8 for Firefox4, Opera, and Chrome -->

      <source type='video/webm; codecs="vp8, vorbis"' src="http://primepresentations.s3.amazonaws.com/2014/ash-tcell/advani/videos/video.webm" />
      <!-- Ogg/Vorbis for older Firefox and Opera versions -->

      <source type='video/ogg; codecs="theora, vorbis"' src="http://primepresentations.s3.amazonaws.com/2014/ash-tcell/advani/videos/video.ogv" />
    </video>
  </div>
